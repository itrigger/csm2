...
<footer id="site-footer" role="contentinfo" class="header-footer-group" >
  <div class="home-page_howto-footer"> <img src="/wp-content/themes/csm/assets/images/homepage-bg-footer.svg" alt=""></div>
  <div class="line2">
    <div class="in">
      <div class="flex">
  ...
  <div class="switch_wrap"><a href="/?switch_theme=desktop">Перейти на полную версию</a></div>
</footer><!-- #site-footer -->
